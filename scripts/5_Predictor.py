...
antibiotici_test = df_test.iloc[:,start+n_pred:start+n_pred+n_antibiotici]
geni_antibiotici_test = df_test.iloc[:,start+n_pred+n_antibiotici:start+n_pred+n_antibiotici+n_geni]
virulenza_test = df_test.iloc[:,start+n_pred+n_antibiotici+n_geni:start+n_pred+n_antibiotici+n_geni+n_virulenza]
...
prediction.to_csv('../'+cartella_pred+'/Results_'+cartella_train+'.csv', index = True)
display(prediction)